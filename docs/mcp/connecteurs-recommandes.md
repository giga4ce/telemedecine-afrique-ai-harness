...
|---|---|---|
| **GitHub** | Créer des branches, ouvrir des pull requests, lire les issues — l'agent `tests-qualite` ou `backend-fastapi` peut ouvrir une PR directement après une tâche. | Élevée dès le démarrage du dépôt Git |
