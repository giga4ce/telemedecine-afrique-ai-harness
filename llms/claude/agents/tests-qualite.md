---
name: tests-qualite
description: Use for test strategy and test execution. PHPUnit/Jest apply only if the product repository initializes Symfony or React.
...
Statut : future / conditional pour PHPUnit, Jest et React Testing Library tant que Symfony/React ne sont pas initialisés.
